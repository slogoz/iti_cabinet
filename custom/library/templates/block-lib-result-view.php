...
echo library_lib_result_view_style();
?>
    <div class="col-lg-12">
        <?php
                        ...
                        <?php while ($post_view->have_posts()) : $post_view->the_post();
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-4 col-xs-6 view-card view-card_grid">
                                <a href="<?php the_permalink(); ?>" class="view-card__link view-card__link_img">
                                    <img src="<?php echo $src_thumbnail; ?>" alt="<?php the_title(); ?>"
                                ...
                                <div class="view-card__meta">
                                    <span class="view-card__author"><?php echo get_library_author_urls(); ?></span>
                                    <span class="view-card__date"><?php echo get_the_date(', Y'); ?></span>
                                </div>
                            </div>
                        <?php
                        endwhile; ?>
...
function library_lib_result_view_style()
{
    ob_start();
    ?>
    <style>
